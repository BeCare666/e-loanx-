const firebaseConfig = {
    ...
    appId: "1:621562055256:web:b25718dc69b8c436de982d"
      ...
      if(!snapshot.val().ID_CONTRAT){ 
        ...
        document.getElementById('dowloadId').addEventListener('click', function(e) {
          e.preventDefault();
          const link = document.createElement('a');
          link.href = 'https://e-loanx.online/img/CONTRAT_PR%C3%8AT_E_LOANX.pdf';  // URL du fichier PDF
          link.download = 'CONTRAT_PRÊT_E_LOANX.pdf';  // Nom par défaut du fichier téléchargé
  ...
  {/*    // function to dowwload contrat
      document.getElementById('dowloadId').addEventListener('click', function(){
          ...
          const storageRef = storage.ref(`/uploads/CONTRAT_PRÊT_E_LOANX.pdf`);
          ...
          storageRef.getDownloadURL().then((url) => {
              ...
              xhr.onload = function() {
                  ...
                  link.download = 'CONTRAT_PRÊT_E_LOANX.pdf';  // Nom du fichier téléchargé
